...
module.exports = class Pool extends events.EventEmitter {
    ...
    SetupPeer() {
        ...
        this.peer = new peer.Peer(this.options);
    ...
    SetupJobManager() {
        this.jobManager = new jobManager.JobManager(this.options);
    ...
    SetupDaemonManager(finishedCallback) {
        ...
        this.daemon = new daemon.DaemonManager(this.options.daemons, function (severity, message) {
            this.emit("log", severity, message);
        });
    ...
    DetectCoinData(finishedCallback) {
        ...
        this.daemon.batchCmd(batchRpcCalls, (error, results) => {
            ...
            this.options.initStats = {
                ...
                difficulty: difficulty * algorithms[this.options.coin.algorithm].multiplier,
    ...
    StartStratumServer(finishedCallback) {
        this.stratumServer = new stratum.StratumServer(this.options, this.authorizeFn);
    ...
    setVarDiff(port, varDiffConfig) {
        ...
        this.varDiff[port] = new vardiff.VarDiff(port, varDiffConfig);
