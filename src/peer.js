...
module.exports = class Peer extends events.EventEmitter {
    constructor(options) {
        ...
        this.magic = new Buffer(this.options.testnet ? this.options.coin.peerMagicTestnet : this.options.coin.peerMagic, "hex");
        ...
        this.relayTransactions = this.options.p2p.disableTransactions === true ? new Buffer([false]) : new Buffer([]);
