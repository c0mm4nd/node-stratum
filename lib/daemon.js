...
module.exports = class DaemonManager extends events.EventEmitter {
    ...
    cmd(method, params, callback, streamResults, returnRawData) {
        const results = [];
        async function _cmd(method, params, callback, streamResults, returnRawData){
            for (let i=0; i<this.instances.length; i++) {
                await ((instance) => {
                    ...
                    this.performHttpRequest(instance, requestJson,
        ...
        _cmd(method, params, callback, streamResults, returnRawData);
