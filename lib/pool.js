...
module.exports = class Pool extends events.EventEmitter {
    ...
    relinquishMiners(filterFn, resultCback) {
        ...
        async function _relinquishMiners(filterFn, resultCback) {
            let clientsToRelinquish = await filterFn(stratumClients);
            await ((clientsToRelinquish) => {
        ...
        _relinquishMiners(filterFn, resultCback);
