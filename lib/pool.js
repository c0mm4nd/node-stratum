...
class Pool extends events_1.EventEmitter {
    ...
    SubmitBlock(blockHex, callback) {
        ...
        this.daemon.cmd(rpcCommand, rpcArgs, function (results) {
    ...
    SetupDaemonInterface(finishedCallback) {
        ...
        this.daemon = new daemon_1.DaemonManager(_this.options.daemons, function (severity, message) {
            _this.emit('log', severity, message);
        });
    ...
    DetectCoinData(finishedCallback) {
        ...
        this.daemon.batchCmd(batchRpcCalls, function (error, results) {
            ...
            _this.options.initStats = {
                ...
                difficulty: difficulty * algoProperties_1.algorithms[_this.options.coin.algorithm].multiplier,
