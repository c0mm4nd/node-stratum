...
export class JobManager extends EventEmitter {
    ...
    updateCurrentJob(rpcData) {
        const tmpBlockTemplate = new BlockTemplate(this.jobCounter.next(), rpcData, this.options.poolAddressScript, this.extraNoncePlaceholder, this.options.coin.reward, this.options.coin.txMessages, this.options.recipients);
